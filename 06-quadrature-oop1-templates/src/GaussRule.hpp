 ...
 *
 * \brief
 * This class implements a one-dimensional Gauss quadrature rule using
 * templates to be applicable to all types of data types
 *
 */
...
// and data type TIndex for all index type data. By default, TData is
// assumed as double and TIndex is assumed as int.
template<typename TData=double, typename TIndex=int>
class GaussRule{
...
public:
  ...
  // GaussRule(){
  //   N = 3;
  //   x = new TData[3] {0.0000000000000000000000000,
  //                      0.7745966692414833770358531,
  //                     -0.7745966692414833770358531};
  //    w = new TData[3] {0.8888888888888888888888889,
